            ...
            <div class="right">
              ...
              <div class="special">
                <div class="content">
                  <div class="leftbar">
                    <ul class="menu">
                      <!-- @click="changeSpecial(item.id, index)" -->
                      <li class="menu-item" v-for="(item, index) in special"  :key="index">
                        <span class="activited" v-if="activited === index"></span>
...
<script>
import leader from '@/assets/pc/leader.png'
import news from '@/assets/pc/news.png'
import act from '@/assets/pc/act.png'
...
#pc-index{
  ...
  .bg-top{
    ...
    .bg-start{
      width: 100%;
      height: calc(100vh);
      background: url('./../../assets/pc/bgc_start.png') no-repeat center center;
