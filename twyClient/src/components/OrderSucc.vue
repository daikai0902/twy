<template>
  <div class="choir-wrap">
    ...
    <div class="choir-text">
      ...
      <p class="p3"><span class="p2">{{course}}</span>  体验课预约已成功</p>
      <p class="p3">具体细节请联系客服！</p>
...
export default {
  ...
  created () {
    ...
    this.course = this.$route.query.c
  }
}
</script>
...
.choir-box{
  opacity:0.6;
  background-image:linear-gradient(-147deg, #003e4f 0%, rgba(92,80,73,0.78) 29%, rgba(65,55,49,0.46) 100%);
  position: fixed;
  z-index: 2;
  width: 100%;
  height: 100%;
